...
/***/ (function(module, exports, __webpack_require__) {
	...
	var isMobile = _browser2.default.versions.mobile && window.screen.width < 1000;
		...
		var app = new _Q2.default({
			...
			ready: function ready() {
				if (!isMobile) {
					...
					var toolsCol = document.querySelector('.tools-col');
					var midCol = document.querySelector('.mid-col');
					// let container = document.querySelector('#container');
					// let size = (window.innerWidth - 1280)/2;
					// leftCol.style.left = size + "px";
					// toolsCol.style.left = size + "px";
					// midCol.style.right = size + "px";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function attemptVertx() {
	  try {
	    var r = require;
	    var vertx = __webpack_require__(435);
